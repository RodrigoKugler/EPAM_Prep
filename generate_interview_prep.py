...
CONCEPTUAL_QUESTIONS = """# EPAM Interview - Conceptual Questions Bank
...
# Write the file
write_file('08_Interview_Prep/Conceptual_Questions.md', CONCEPTUAL_QUESTIONS)

print("\n✅ Interview prep materials generated!")

if __name__ == "__main__":
    print("="*70)
    print("Generating Interview Preparation Materials")
    print("="*70)
    print()
